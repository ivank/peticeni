defmodule PeticeniWeb.CoreComponents do
  @moduledoc """
              ...
              >
                ...
                >
                  ...
                  <td :if={@action != []} class="relative w-14 p-0">
                    <div class="relative whitespace-nowrap px-6 py-4 text-right text-sm font-medium">
                      <span class="absolute -inset-y-px -right-4 left-0 group-hover:bg-gray-100 dark:group-hover:bg-gray-700 sm:rounded-r-xl" />
                      <span
                        :for={action <- @action}
                        class="relative ml-4 font-semibold leading-6 text-gray-800 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                      >
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PeticeniWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PeticeniWeb.Gettext, "errors", msg, opts)
    end
  end
